package com.pesto.taskmanagement.fragments.list
...
import com.pesto.taskmanagement.fragments.list.adapter.ListAdapter
import com.pesto.taskmanagement.utils.hideKeyboard
import com.pesto.taskmanagement.utils.observeOnce
import com.google.android.material.snackbar.Snackbar
import com.pesto.taskmanagement.R
import com.pesto.taskmanagement.databinding.FragmentListBinding
...
class ListFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId) {
            ...
            R.id.menu_todo -> mToDoViewModel
                .sortedDataToDo
                .observe(viewLifecycleOwner) {
                    listAdapter.setData(it)
                }
            R.id.menu_in_progress -> mToDoViewModel
                .sortedDataInProgress
                .observe(viewLifecycleOwner) {
                    listAdapter.setData(it)
                }
            R.id.menu_done -> mToDoViewModel
                .sortedDataDone
                .observe(viewLifecycleOwner) {
                    listAdapter.setData(it)
                }
    ...
    private fun confirmRemoval() {
        val alertDialog = AlertDialog.Builder(requireContext()).apply {
            setPositiveButton("YES") { _, _ ->
                ...
                Toast.makeText(
                        requireContext(),
                        "Successfully Cleared everything! ",
                        Toast.LENGTH_SHORT
                ).show()
            }
